...
export default function App() {
  ...
  useEffect(() => {
    ...
    getAsync('wc26_octavosSubstitutions', {}).then(fbOctSubs => {
      setOctavosSubstitutions(fbOctSubs)
    })

    getAsync('wc26_cuartosSubstitutions', {}).then(fbCtoSubs => {
      setCuartosSubstitutions(fbCtoSubs)
    })

    getAsync('wc26_cuartosGroupInfo', {}).then(fbCtoGroupInfo => {
      setCuartosGroupInfo(fbCtoGroupInfo)
    })
  ...
  const clearAllData = () => {
    ...
    setSimulatedPhases({ R16: false, OCT: false, CTO: false, SEMI: false, '3P': false, FIN: false })
    setResultsConfirmed({ 1: false, 2: false, 3: false, R16: false, OCT: false, CTO: false, SEMI: false, '3P': false, FIN: false })
    setR16Confirmed(false)
    setR16MatchupsConfirmed(false)
    setR16Substitutions({})
    ...
    setAsync('wc26_simulatedPhases', { R16: false, OCT: false, CTO: false, SEMI: false, '3P': false, FIN: false })
    setAsync('wc26_resultsConfirmed', { 1: false, 2: false, 3: false, R16: false, OCT: false, CTO: false, SEMI: false, '3P': false, FIN: false })
    setAsync('wc26_r16Confirmed', false)
    setAsync('wc26_r16MatchupsConfirmed', false)
